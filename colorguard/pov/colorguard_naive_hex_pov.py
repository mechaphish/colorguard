...
from .c_templates import naive_hex_c_template

import logging

l = logging.getLogger("colorguard.pov.ColorguardNaiveHexExploit")

class ColorguardNaiveHexExploit(CGCExploit):
    """
    ...
    def __init__(self, binary, payload, stdout_len, leaked_bytes):
        ...
        super(ColorguardNaiveHexExploit, self).__init__(crash, cgc_type=2, bypasses_nx=True, bypasses_aslr=True)
        ...
        self._flag_byte_5 = leaked_bytes[4]
        self._flag_byte_6 = leaked_bytes[5]
        self._flag_byte_7 = leaked_bytes[6]
        self._flag_byte_8 = leaked_bytes[7]
    ...
    def dump_c(self, filename=None):
        ...
        fmt_args["flag_byte_5"] = hex(self._flag_byte_5)
        fmt_args["flag_byte_6"] = hex(self._flag_byte_6)
        fmt_args["flag_byte_7"] = hex(self._flag_byte_7)
        fmt_args["flag_byte_8"] = hex(self._flag_byte_8)

        c_code = naive_hex_c_template
