...
int do_pov() {
  ...
  char hex_flag[8];
  hex_flag[0] = received_data[{flag_byte_1}];
  hex_flag[1] = received_data[{flag_byte_2}];
  hex_flag[2] = received_data[{flag_byte_3}];
  hex_flag[3] = received_data[{flag_byte_4}];
  hex_flag[4] = received_data[{flag_byte_5}];
  hex_flag[5] = received_data[{flag_byte_6}];
  hex_flag[6] = received_data[{flag_byte_7}];
  hex_flag[7] = received_data[{flag_byte_8}];


  char flag[4];
  from_hex(flag, hex_flag);
